 ...
 */
object PromotionRoute : NavRoute<PromotionViewModel> {

    override val route = "promotion/"

    @Composable
    override fun viewModel(): PromotionViewModel = hiltViewModel()

    @Composable
    override fun Content(viewModel: PromotionViewModel) = PromotionPage(viewModel)
}
...
private fun PromotionPage(
    ...
    Column(
        ...
        Text(
            text = context.getString(R.string.promotion_screen_title),
...
{
     var viewModel = PromotionViewModel(MyRouteNavigator())
    PromotionPage(viewModel)
}