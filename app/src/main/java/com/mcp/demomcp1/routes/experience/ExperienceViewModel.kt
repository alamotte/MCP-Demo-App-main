...
class ExperienceViewModel @Inject constructor(
    ...
    private val trackingAction = context.getString(R.string.experience_screen_action)
    private val campaignTarget: String = context.getString(R.string.experience_campaign_action)
    ...
    fun onCtaClicked(p : Int) {
        ...
        startActivity(MCPApplication.instance.currentActivity.applicationContext, browserIntent, null)
    }
}